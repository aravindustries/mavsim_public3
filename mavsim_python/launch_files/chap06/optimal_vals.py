...
parser.add_argument("--cki", type=float, default=-1.8430787645968727)
parser.add_argument("--ckp", type=float, default=37.49326950203059)
parser.add_argument("--rkp", type=float, default=5.055842)
parser.add_argument("--rkd", type=float, default=6.593528)
parser.add_argument("--yk", type=float, default=6.219254)
parser.add_argument("--yw", type=float, default=5.719866)
...
parser.add_argument("--outfile", type=str, default="launch_files/chap06/rmse_results.csv")
...
while sim_time < end_time:
    ...
    time.sleep(0) # slow down the simulation for visualization
